  ...
  function formatDescription(desc: string) {
    return desc.split("\n").map((line, idx) => {
      ...
      if (trimmed.startsWith("•") || trimmed.startsWith("-")) {
        return (
          <li key={idx} className="ml-4 list-disc text-slate-500 font-light text-[12px] leading-[16px]">
      ...
      if (trimmed.startsWith("⚠")) {
        return (
          <p key={idx} className="font-normal text-amber-600 flex items-center gap-1.5 mt-1.5 mb-1 text-[12px] leading-[16px]">
            <span className="text-amber-500">⚠</span> {trimmed.substring(1).trim()}
          </p>
        );
      }
      return (
        <p key={idx} className="font-light text-slate-500 text-[12px] leading-[16px]">
          {line}
        </p>
      );
    });
        ...
        <div className="grid lg:grid-cols-[1.05fr_0.95fr] gap-12 lg:gap-16 items-center w-full">
          ...
          <div className="flex flex-col gap-5 max-w-[596px]">
            ...
            <div className="text-[18px] leading-[28px] font-light text-[#475569] space-y-4">
              ...
              <p>
                Majhne izboljšave lahko prihranijo čas, zmanjšajo napake in pustijo boljši vtis pri
                strankah.
              </p>
            </div>
          ...
          <div className="relative w-full max-w-[556px] justify-self-center lg:justify-self-end">
            ...
            >
              ...
              <div className="flex justify-between items-start gap-4">
                ...
                <div className="w-11 h-11 bg-[#EFF6FF] border border-[#DBEAFE] shadow-[inset_0px_1px_0px_1px_#FFFFFF] rounded-2xl flex items-center justify-center text-[#2563EB] shrink-0">
                  ...
                  {slides.map((slide, idx) => (
                    <button
                      ...
                      className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
                        activeSlide === idx ? "bg-[#0F172A] scale-125" : "bg-[#CBD5E1] hover:bg-slate-400"
                      }`}
